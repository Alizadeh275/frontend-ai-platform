...
export function Layout({ children, currentPage, setCurrentPage, theme, toggleTheme }: LayoutProps) {
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors duration-300">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="hidden md:block">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">AI Infrastructure Platform</p>
              </div>
            </div>
          </div>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="gap-2 px-2">
                  ...
                  <span className="hidden md:block text-sm font-medium">علی کریمی</span>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuItem className="text-red-600">خروج از سیستم</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </div>
        </div>
      ...
      >
        ...
        <div className="absolute bottom-4 left-4 right-4 p-4 rounded-xl bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/50 dark:to-purple-950/50 border border-blue-200 dark:border-blue-800">
          <div className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">وضعیت سیستم</div>
          <div className="space-y-2 text-xs">
            <div className="flex justify-between items-center">
              <span className="text-gray-600 dark:text-gray-400">GPU فعال</span>
              <Badge variant="secondary" className="bg-green-500/10 text-green-700 dark:text-green-400">8/12</Badge>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-600 dark:text-gray-400">نوت‌بوک‌های فعال</span>
              <Badge variant="secondary" className="bg-blue-500/10 text-blue-700 dark:text-blue-400">15</Badge>
            </div>
          </div>
        </div>
      </aside>
      ...
      {/* Main Content */}
      <main className={`pt-16 transition-all duration-300 ${sidebarOpen ? 'pr-0 lg:pr-64' : 'pr-0'}`}>
