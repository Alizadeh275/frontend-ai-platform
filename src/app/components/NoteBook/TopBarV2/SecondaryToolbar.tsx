      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 bg-white rounded-full border border-gray-200/80 shadow-sm px-1 py-1">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-all duration-200 group"
          >
        ...
        <div className="flex items-center gap-2 bg-white rounded-full border border-gray-200/80 shadow-sm px-1 py-1">
          ...
          <button
            onClick={onDownload}
            className="flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-all duration-200"
            title="دانلود پروژه"
          >
        ...
        <div className="flex items-center gap-2 bg-white rounded-full border border-gray-200/80 shadow-sm px-2 py-1">
          <button
            onClick={onRunAll}
            className="flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium text-white bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 shadow-sm hover:shadow transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
